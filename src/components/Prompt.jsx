...
export const Prompt = () => {
  return (
    <div className="fixed bottom-0 bg-transparent mb-3 flex flex-col justify-center items-center">
      {/* <div className="w-10 h-10 mb-5 rounded-full bg-white border-2 border-gray-200 flex items-center justify-center">
        <Icons.ArrowDown className="cursor-pointer" />
      </div> */}
      <div className=" bg-white rounded-3xl border-2 border-gray-200">
        <textarea
          className="w-250 h-20 overflow-y-auto p-5 text-lg text-gray-600 bg-transparent outline-none resize-none"
